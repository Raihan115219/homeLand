...
import { BiArea, BiBadge, BiBath, BiBed } from "react-icons/bi";
    ...
    <section>
      <div className="container mx-auto min-h-[800px] mb-14">
        ...
        <div className="flex flex-col items-start gap-8 lg:flex-row">
          ...
          <di className="flex-1 bg-white w-full mb-8 border border-gray-300 rounded-lg px-6 py-8  ">
            ...
            <form className="flex flex-col gap-y-4 ">
              ...
              <textarea
                ...
                placeholder="Message
              "
                defaultValue="Hello! I am interested in [Mordern Appertament]"
              ></textarea>
